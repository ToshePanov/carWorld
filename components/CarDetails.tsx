            ...
            <Transition appear show={isOpen} as={Fragment}>
                <Dialog as="div" className="relative z-10" onClose={closeModal}>
                    <Transition.Child
                        ...
                        leaveTo="opacity-0">
                        <div className="fixed inset-0 bg0black bg-opacity-25" />
                    </Transition.Child>
                        ...
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex flex-col gap-5">
                                    <button
                                        type="button"
                                        className="absolute top-2 right-2 z-10 w-fit p-2 bg-secondary-blue-100 rounded-full"
                                        onClick={closeModal}
                                    >
                                    ...
                                    <div className="flex-1 flex flex-col gap-3">
                                        ...
                                        <div className="flex gap-3">
                                            <div className="flex-1 relative w-full h-24 bg-secondary-blue-100 rounded-lg">
